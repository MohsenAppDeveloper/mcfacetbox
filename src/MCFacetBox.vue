...
const scrollItemHeightDefault = 42
...
const searchIcon = computed(() => 'mdi-magnify')
  ...
  <VCard class="mc-facet-box px-1" variant="flat" :dir="effectiveDir">
    ...
    <div class="search-container pt-2">
      <VTextField
        ...
        placeholder="Search"
        :append-inner-icon="effectiveDir === 'ltr' ? searchIcon : undefined"
        :prepend-inner-icon="effectiveDir === 'rtl' ? searchIcon : undefined"
    ...
    <VList class="custom-scrollbar"
      ...
      :return-object="false" :height="(filteredItems.length ?? 10) * ((props.scrollItemHeight ?? scrollItemHeightDefault)+1)" :max-height="(props.scrollItemCount ?? 10) * (props.scrollItemHeight ?? scrollItemHeightDefault)"
    >
    ...
    <div v-else-if="(props.istree || props.facettype === FacetType.tree)"  style="--block-size-offset:5px">
      <VTreeview style="padding-inline: .5rem;" class="custom-scrollbar"
    ...
    <div v-else class="d-flex align-center justify-space-between">
      ...
      <VSwitch style="padding-inline: .5rem;" v-model="switchState" class="pl-2" @update:model-value="chagenSwitchValue" />
    </div>
  </VCard>
</template>
...
.custom-scrollbar {
    ...
    // حالت افقی - برای کنترل دقیق‌تر
    &::-webkit-scrollbar:horizontal {
        block-size: 4px; // مقدار دلخواه برای کاهش ضخامت اسکرول بار افقی
    }
  }
.search-container {
    padding-inline: 10px;
